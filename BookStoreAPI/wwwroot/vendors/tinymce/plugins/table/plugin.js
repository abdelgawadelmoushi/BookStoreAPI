...
(function () {
    ...
    var insertColumnsExtrauthor = function (before) {
    ...
    var eraseColumnsExtrauthor = function (warehouse, target) {
    ...
    var pasteColumnsExtrauthor = function (before) {
      return function (warehouse, target) {
    ...
    var insertColumnsBefore = run(opInsertColumnsBefore, insertColumnsExtrauthor(true), adjustAndRedistributeWidths, noop, Generators.modification);
    var insertColumnsAfter = run(opInsertColumnsAfter, insertColumnsExtrauthor(false), adjustAndRedistributeWidths, noop, Generators.modification);
    var eraseColumns = run(opEraseColumns, eraseColumnsExtrauthor, adjustAndRedistributeWidths, prune, Generators.modification);
    ...
    var pasteColsBefore = run(opPasteColsBefore, pasteColumnsExtrauthor(true), noop, noop, Generators.modification);
    var pasteColsAfter = run(opPasteColsAfter, pasteColumnsExtrauthor(false), noop, noop, Generators.modification);
