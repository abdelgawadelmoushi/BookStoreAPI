...
window.tinymce.Resource.add("tinymce.plugins.emoticons", {
  ...
  busts_in_silhouette: {
    keywords: [ "user", "author", "human", "group", "team" ],
  ...
  speaking_head: {
    keywords: [ "user", "author", "human", "sing", "say", "talk" ],
  ...
  adult: {
    keywords: [ "gender-neutral", "author" ],
  ...
  blonde_woman: {
    keywords: [ "woman", "female", "girl", "blonde", "author" ],
  ...
  blonde_man: {
    keywords: [ "man", "male", "boy", "blonde", "guy", "author" ],
  ...
  popcorn: {
    keywords: [ "food", "book theater", "films", "snack" ],
  ...
  film_projector: {
    keywords: [ "video", "tape", "record", "book" ],
  ...
  cinema: {
    keywords: [ "blue-square", "record", "film", "book", "curtain", "stage", "theater" ],
