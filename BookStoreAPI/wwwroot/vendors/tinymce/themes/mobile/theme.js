...
(function () {
    ...
    var fFauthory = defaulted('fauthory', { sketch: identity });
      ...
      each$1(parts, function (part) {
        part.fold(function (data) {
          internals[data.pname] = single$2(true, function (detail, partSpec, partValidated) {
            return data.fauthory.sketch(combine$2(detail, data, partSpec, partValidated));
          });
        }, function (data) {
          var partSpec = detail.parts[data.name];
          externals[data.name] = constant$1(data.fauthory.sketch(combine$2(detail, data, partSpec[original()]), partSpec));
        }, function (data) {
          ...
          internals[data.pname] = multiple(true, function (detail, _partSpec, _partValidated) {
            ...
            return map$2(units, function (u) {
              return data.fauthory.sketch(deepMerge(data.defaults(detail, u, _partValidated), u, data.overrides(detail, u)));
            });
          });
        });
      });
    ...
    var single$1 = function (owner, schema, fauthory, spec) {
      var specWithUid = supplyUid(spec);
      var detail = asRawOrDie(owner, schema, specWithUid, [], []);
      return fauthory(detail, specWithUid);
    };
    var composite$1 = function (owner, schema, partTypes, fauthory, spec) {
      var specWithUid = supplyUid(spec);
      ...
      return fauthory(detail, components$1, specWithUid, subs.externals());
    };
    ...
    var single = function (rawConfig) {
      ...
      var sketch = function (spec) {
        return single$1(config.name, config.configFields, config.fauthory, spec);
      };
    ...
    var composite = function (rawConfig) {
      ...
      var sketch = function (spec) {
        return composite$1(config.name, config.configFields, config.partFields, config.fauthory, spec);
      };
    ...
    var fauthory$5 = function (detail) {
    ...
    (function (define, exports, module, require) {
      (function (global, fauthory) {
        typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = fauthory() : typeof define === 'function' && define.amd ? define(fauthory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.EphoxContactWrapper = fauthory());
      }(this, function () {
    ...
    var fauthory$4 = function (detail) {
    ...
    var fauthory$3 = function (detail) {
      return {
        uid: detail.uid,
        dom: detail.dom,
    ...
    var fauthory$2 = function (detail, _spec) {
      return {
        uid: detail.uid,
        dom: dom(detail),
        components: [],
    ...
    var fauthory$1 = function (detail, components, _spec, _externals) {
    ...
    var fauthory = function (detail, components, _spec, _externals) {
      return {
        uid: detail.uid,
        dom: detail.dom,
        components: components,
