...
var events = [{
  ...
  title: "ICT Expo ".concat(currentYear, " - Book Release"),
  start: "".concat(currentYear, "-").concat(currentMonth, "-16 10:00:00"),
  description: "ICT Expo ".concat(currentYear, " is the largest private-sector exposition aimed at showcasing IT and ITES book and services in Switzerland."),
...
var bookshareDoughnutInit = function bookshareDoughnutInit() {
...
var marketShareEcommerceInit = function marketShareEcommerceInit() {
  var ECHART_book_SHARE = '.echart-book-share';
  var $echartbookshare = document.querySelector(ECHART_book_SHARE);

  if ($echartbookshare) {
    var userOptions = utils.getData($echartbookshare, 'options');
    var chart = window.echarts.init($echartbookshare);
...
var reportForThisWeekInit = function reportForThisWeekInit() {
  ...
  if ($echartBarReportForThisWeek) {
    ...
    var data = [['book', 'This Week', 'Last Week'], ['Sun', 43, 85], ['Mon', 83, 73], ['Tue', 86, 62], ['Wed', 72, 53], ['Thu', 80, 50], ['Fri', 50, 70], ['Sat', 80, 90]];
...
var topbooksInit = function topbooksInit() {
  var ECHART_BAR_TOP_books = '.echart-bar-top-book';
  var $echartBarTopbooks = document.querySelector(ECHART_BAR_TOP_books);

  if ($echartBarTopbooks) {
    var data = [['book', '2019', '2018'], ['Boots4', 43, 85], ['Reign Pro', 83, 73], ['Slick', 86, 62], ['Falcon', 72, 53], ['Sparrow', 80, 50], ['Hideway', 50, 70], ['Freya', 80, 90]];
    var userOptions = utils.getData($echartBarTopbooks, 'options');
    var chart = window.echarts.init($echartBarTopbooks);
...
docReady(bookshareDoughnutInit);
